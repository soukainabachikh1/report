...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.1]{Images/skype.png} % Replace with the actual filename of the IBM logo image
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.3]{Images/git.jpg} % Replace with the actual
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.3]{Images/gitlab.jpg} % Replace with the actual
...
Sur la figure \ref{fig:lab} est représenté notre code source dans GitLab.
    \begin{figure}[h]
        \centering
        \includegraphics[scale=0.7]{gitlab/whole2.jpg} % Replace with the actual
