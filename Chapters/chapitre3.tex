...
\begin{figure}[htbp]
   \centering
   \includegraphics[scale=0.85]{Images/1.jpg} % Replace with the actual filename of the IBM logo image
...
\begin{figure}[htbp]
   \centering
   \includegraphics[scale=0.5]{Images/physique.jpg} % Replace with the actual filename of the IBM logo image
...
\begin{figure}[htbp]
   \centering
   \includegraphics[scale=0.7]{diag/class2.png} % Replace with the actual filename of the IBM logo image
...
Le diagramme de la figure \ref{fig:seq2} illustre comment s'effectue la création d'une offre par un recruteur en saisissant les informations nécessaires.
\\
\begin{figure}[H]
   \centering
...
\begin{sidewaysfigure}
   \centering
   \includegraphics[scale=0.9]{diag/sd3.jpg} % Replace with the actual filename of the IBM logo image
