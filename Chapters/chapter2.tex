...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{Images/candidat.png} % Replace with the actual filename of the IBM logo image
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{Images/recruteur.png} % Replace with the actual filename of the IBM logo image
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.55]{Images/admin.png} % Replace with the actual filename of the IBM logo image
